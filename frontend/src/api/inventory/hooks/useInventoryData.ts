...
/**
 * Helper to extract finite number from value (string or number).
 * Used for parsing field values in API responses.
 */
...
/**
 * Helper to try a list of keys and return the first numeric value found.
 * Used for backend field name variations.
 */
