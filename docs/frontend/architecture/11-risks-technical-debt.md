...
| FR-03 | Client-side inventory filtering compensates for a name-only search endpoint | Low — correct but wasteful on large pages | Backend search extension would remove the client fallback ([§5.1](05-domains/inventory.md)) |
