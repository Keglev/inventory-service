...
- **[Architectural Diagrams](./diagrams/index.html)** - Visual diagrams showing system context, layers, deployment, request flows, database schema, security flows, and analytics architecture
