...
- [Controller Layer Patterns](controller-patterns.md) - REST API validation integration
...
- [Security Configuration Patterns](security-patterns.md) - OAuth2 authentication for DTO access
- [Configuration Patterns](configuration-patterns.md) - Demo mode and conditional DTO access
